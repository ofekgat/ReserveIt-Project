...
/**
 * Same admin gate as the server tier's AdminFilter: pages this filter is
 * mapped to require a signed-in user whose Role is ADMIN. Checks the raw
 * HttpSession attributes UserSessionBean.markLoggedIn() sets, since this
 * filter runs before JSF would lazily create the bean.
 */
